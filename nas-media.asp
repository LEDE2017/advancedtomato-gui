		...
		<div class="box" id="dlna" data-box="dlna-media-serv">
			...
			<script type="text/javascript">
				...
				$('.content.mediadlna').forms([
					...
					{ title: '端口', indent: 2, name: 'ms_port', type: 'text', maxlen: 5, size: 6, value: nvram.ms_port, suffix: '<small>(范围: 0 - 65535; 默认(随机)设置为0</small>' },
					{ title: '数据库位置', multi: [
				...
				$('#dlna .heading').append('<small ' + (mdup ? 'class="text-success">(运行中' : 'class="text-danger">(停止') + ')</small>');
			</script>
		</div>
