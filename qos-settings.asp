	...
	<form id="_fom" method="post" action="tomato.cgi">
		...
		<div class="box" data-box="qos-out-limits">
			...
			<script type="text/javascript">
				...
				for (var uidx = 1; uidx <= nvram.mwan_num; ++uidx){
					var u = (uidx >1) ? uidx : '';
					f.push({ title: 'WAN '+uidx+'<br>最大带宽限制', name: 'wan'+u+'_qos_obw', type: 'text', maxlen: 12, size: 8, suffix: ' <small>kbit/s </small>', value: nvram['wan'+u+'_qos_obw'] });
				}
		...
		<div class="box" data-box="qos-in-limits">
			...
			<script type="text/javascript">
				...
				for (var uidx = 1; uidx <= nvram.mwan_num; ++uidx){
					var u = (uidx >1) ? uidx : '';
					f.push({ title: 'WAN '+uidx+'<br>最大带宽限制', name: 'wan'+u+'_qos_ibw', type: 'text', maxlen: 12, size: 8, suffix: ' <small>kbit/s </small>', value: nvram['wan'+u+'_qos_ibw'] });
				}
