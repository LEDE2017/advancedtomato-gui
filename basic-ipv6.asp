				...
				<script type="text/javascript">
					...
					$('#section-ipv6 .formfields').forms([
		                 { title: 'IPv6 服务类型', name: 'ipv6_service', type: 'select',
		                     options: [['', '禁用'],['native-pd','前缀授权 DHCPv6'],['native','静态 IPv6'],['6to4','6to4 选播中继'],['sit','6in4 静态隧道'],['6rd','6rd 中继'],['6rd-pd','6rd 从 DHCPv4 派生(可选212)'],['other','其他（手动配置)']],
                             value: nvram.ipv6_service },
		                 { title: 'IPv6 广域网接口', name: 'ipv6_ifname', type: 'text', maxlen: 8, size: 10, value: nvram.ipv6_ifname },
		                 null,
                         { title: 'IPv6 广域网地址', name: 'f_ipv6_wan_addr', type: 'text', maxlen: 40, size: 42, value: nvram.ipv6_wan_addr, suffix: ' <small>(例. 2001:0db8:1234::2)</small>' },
                         { title: 'IPv6 广域网前缀长度', name: 'f_ipv6_prefix_len_wan', type: 'text', maxlen: 3, size: 5, value: nvram.ipv6_prefix_len_wan, suffix: ' <small>(通常是  64)</small>' },
                         { title: 'IPv6 广域网网关', name: 'f_ipv6_isp_gw', type: 'text', maxlen: 40, size: 42, value: nvram.ipv6_isp_gw, suffix: ' <small>(例. 2001:0db8:1234::1)</small>' },
                         { title: '分配/路由 前辍', name: 'f_ipv6_prefix', type: 'text', maxlen: 40, size: 42, value: nvram.ipv6_prefix, suffix: ' <small>(例. 2001:0db8:1234:0001::)</small>' },
		                 ...
		                 { title: '仅请求PD', name: 'f_ipv6_pdonly', type: 'checkbox', value: (nvram.ipv6_pdonly != '0'), suffix: ' <small>(通常是 PPPoE 连接)</small>' },
                         { title: '路由器 IPv6 地址', multi: [
