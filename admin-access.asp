		...
		<div class="box" id="section-ssh" data-box="access-ssh">
			...
			<div class="content">
				<script type="text/javascript">
					...
					$('.ssh-status').html((sdup ? '<small class="text-success">(运行中)</small>' : '<small class="text-danger">(停止)</small>'));
				</script>
			</div>
		</div>
		...
		<div class="box" id="section-telnet" data-box="access-telnet">
			...
			<div class="content">
				<script type="text/javascript">
					...
					$('.telnet-status').html((tdup ? '<small class="text-success">(运行中)</small>' : '<small class="text-danger">(停止)</small>'));
				</script>
			</div>
		</div>
